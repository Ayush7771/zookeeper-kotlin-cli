...
fun main() {
    while (true) {
        ...
        if (index == null || index !in animals.indices) {
            println("Something went wrong!, please try again. Please enter between 0 to 5 in digits or \"exit\" for exit the program.")
        } else {
